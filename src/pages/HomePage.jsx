        ...
        <div className="container">
          ...
          <div className="portfolio-grid">
            {[
              ...
              { icon: 'corporate_fare',title: 'Commercial Tower',    loc: 'Nairobi, Kenya',  h5: 'Green Business Park',       desc: 'Eco-friendly commercial complex with smart technology, rooftop gardens, and energy-efficient systems across 20 premium floors.' },
              ...
              { icon: 'weekend',       title: 'Interior Design',     loc: 'Nairobi, Kenya',  h5: 'Executive Office Suites',   desc: 'Premium fit-out for a multinational corporation, combining minimalism with African craftsmanship across 3 executive floors.' },
              { icon: 'account_balance',title:'Heritage Restoration', loc: 'Lamu, Kenya',    h5: 'Swahili Heritage Hotel',    desc: 'Thoughtful restoration of a 19th-century Swahili stone house into a boutique hotel, preserving original features while adding modern amenities.' },
            ].map((p, i) => (
                ...
                <div className="contact-detail-item">
                  ...
                  <div className="contact-detail-text">
                    ...
                    <div className="contact-whatsapp-buttons">
                      ...
                      <a href="https://wa.me/254794980508?text=Hello%20Synergy%20Hub%20Africa!" target="_blank" rel="noopener noreferrer" className="btn btn-whatsapp" style={{ fontSize: '0.8rem', padding: '10px 18px', background: '#128C7E' }}>
                        <MS fill={1}>chat</MS> 0794 980 508
                      </a>
                    </div>
                  </div>
                </div>
